...
class TestListarTarefas:
    ...
    def test_filtrar_por_status(self, gerenciador_limpo):
        ...
        gerenciador_limpo.criar_tarefa("Tarefa 1")
        gerenciador_limpo.criar_tarefa("Tarefa 2")
        gerenciador_limpo.atualizar_status(1, "Em Progresso")

        tarefas_todo = gerenciador_limpo.listar_tarefas(filtro_status="A Fazer")
        tarefas_progress = gerenciador_limpo.listar_tarefas(filtro_status="Em Progresso")
    ...
    def test_filtrar_status_e_prioridade(self, gerenciador_limpo):
        ...
        gerenciador_limpo.atualizar_status(1, "Concluído")
...
class TestAtualizarTarefa:
    ...
    def test_atualizar_status_sucesso(self, gerenciador_limpo):
        ...
        gerenciador_limpo.criar_tarefa("Tarefa Teste")
        resultado = gerenciador_limpo.atualizar_status(1, "Em Progresso")
    ...
    def test_atualizar_status_tarefa_inexistente(self, gerenciador_limpo):
        ...
        resultado = gerenciador_limpo.atualizar_status(999, "Concluído")
    ...
    def test_atualizar_status_para_done_registra_data(self, gerenciador_limpo):
        """Testa que ao marcar como Concluído, registra data de conclusão."""
        gerenciador_limpo.criar_tarefa("Tarefa Teste")
        gerenciador_limpo.atualizar_status(1, "Concluído")
...
class TestEstatisticas:
    ...
    def test_estatisticas_vazio(self, gerenciador_limpo):
        ...
        assert stats["por_status"]["A Fazer"] == 0
        assert stats["por_status"]["Em Progresso"] == 0
        assert stats["por_status"]["Concluído"] == 0
    ...
    def test_estatisticas_completas(self, gerenciador_limpo):
        ...
        gerenciador_limpo.atualizar_status(1, "Em Progresso")
        gerenciador_limpo.atualizar_status(2, "Concluído")

        stats = gerenciador_limpo.obter_estatisticas()

        assert stats["total"] == 4
        assert stats["por_status"]["A Fazer"] == 2
        assert stats["por_status"]["Em Progresso"] == 1
        assert stats["por_status"]["Concluído"] == 1
