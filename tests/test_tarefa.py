...
class TestCriacaoTarefa:
    ...
    def test_tarefa_inicia_com_status_to_do(self):
        """Testa que toda tarefa nova começa com status 'A Fazer'."""
...
class TestAtualizarStatus:
    ...
    def test_atualizar_para_in_progress(self):
        """Testa atualização de status para 'Em Progresso'."""
        tarefa = Tarefa(1, "Tarefa Teste")
        resultado = tarefa.atualizar_status("Em Progresso")

        assert resultado is True
        assert tarefa.status == "Em Progresso"

    def test_atualizar_para_done(self):
        """Testa atualização de status para 'Concluído'."""
        tarefa = Tarefa(1, "Tarefa Teste")
        resultado = tarefa.atualizar_status("Concluído")
    ...
    def test_atualizar_para_status_invalido(self):
        ...
        assert tarefa.status == "A Fazer"  # Permanece no status original

    def test_data_conclusao_apenas_quando_done(self):
        """Testa que data_conclusao só é preenchida quando status é 'Concluído'."""
        tarefa = Tarefa(1, "Tarefa Teste")

        tarefa.atualizar_status("Em Progresso")
        assert tarefa.data_conclusao is None

        tarefa.atualizar_status("Concluído")
        assert tarefa.data_conclusao is not None
    ...
    def test_todos_status_validos(self):
        ...
        assert tarefa.atualizar_status("A Fazer") is True
        assert tarefa.atualizar_status("Em Progresso") is True
        assert tarefa.atualizar_status("Concluído") is True
...
class TestConversaoDicionario:
    ...
    def test_to_dict(self):
        ...
        assert dicionario["status"] == "A Fazer"
    ...
    def test_ciclo_completo_dict(self):
        ...
        tarefa_original.atualizar_status("Em Progresso")
